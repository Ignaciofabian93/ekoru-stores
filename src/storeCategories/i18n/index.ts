...
/**
 * I18N Service - Stateless language utilities for the storeCategories subdomain
 *
 ...
 */
@Injectable()
export class I18nStoreCategoryService {
   ...
   *
   * @example
   * translate('errors.store_category_not_found', Language.EN, { slug: 'moda' })
   * // → "Store category with slug 'moda' not found"
   */
  translate(
    key: string,
    language: Language,
